...
/** Options for creating a configurator layout */
export interface ConfiguratorLayoutOptions {
...
/** The complete resolved configurator layout */
export interface ConfiguratorLayoutData {
  ...
  options: Required<
    Omit<ConfiguratorLayoutOptions, "jointOverrides" | "jointStrategy">
  > & {
    jointStrategy: JointStrategy;
    jointOverrides: Record<number, JointType>;
  };
